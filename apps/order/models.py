...
class OrderInfo(BaseModel):
    ...
    choose_time = models.DateTimeField(verbose_name='选择时间', null=True)
    sp1 = models.CharField(max_length=11, verbose_name='标识', null=True)
    sp2 = models.CharField(max_length=11, verbose_name='标识', null=True)
    deliver_status = models.SmallIntegerField(default=1, choices=DELIVER_STATUS_CHOICES, verbose_name='配送状态')
    sp3 = models.CharField(max_length=11, verbose_name='准时率', null=True)
